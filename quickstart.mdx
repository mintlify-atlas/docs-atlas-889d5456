---
title: "Instalar y ejecutar LEFA en tu equipo"
sidebarTitle: "Inicio rápido"
description: "Instala LEFA en Linux o Windows, configura tus datos de emisor y emite tu primera factura paso a paso en menos de diez minutos."
---
...
La primera vez verás mensajes como *«Creando entorno virtual…»* e *«Instalando dependencias…»*. En las ejecuciones posteriores el arranque es inmediato porque el entorno ya existe.
...
|---|---|
| `LEFA_PROJECT_DIR` | Ruta raíz del proyecto. Útil cuando LEFA se instala en una ubicación diferente al directorio de trabajo actual (por ejemplo, un paquete `.deb` en `/usr/share/`). |
