...
En instalaciones empaquetadas o configuraciones especiales, LEFA reconoce dos variables de entorno opcionales que pueden afectar a la ubicación de los archivos:

| Variable | Descripción |
|---|---|
| `LEFA_PROJECT_DIR` | Raíz del proyecto (útil en instalaciones empaquetadas para apuntar a una ubicación no estándar) |
| `LEFA_VENV` | Ruta explícita al entorno virtual de Python utilizado por LEFA |

En la mayoría de instalaciones domésticas estas variables no son necesarias y LEFA usa las rutas predeterminadas bajo `~/.lefa`.
